...
public class TestPCD10 {
    ...
    public void validateTest() throws Exception {
        ...
        File f = new File(TestPCD10.class.getResource("/PCD10/message.hl7").toURI());
//        System.out.println(f.exists());
        
        String messageString = FileUtils.readFileToString(f);

        Report report = validator.check(messageString, "5a81af6984ae50488e8800b2");
    ...
    private static SyncHL7Validator createValidator()
        ...
        // The profile in XML
        InputStream profileXML =  TestPCD10.class.getResourceAsStream("/PCD10/Profile.xml");

        // The default conformance context file XML
        InputStream contextXML = TestPCD10.class.getResourceAsStream("/PCD10/Constraints.xml");

        // The value set library file XML
        InputStream vsLibXML = TestPCD10.class.getResourceAsStream("/PCD10/ValueSets.xml");
