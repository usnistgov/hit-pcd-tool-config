...
public class TestPCD01 {
    ...
    public void validateTest() throws Exception {
        ...
        File f = new File(TestPCD01.class.getResource("/PCD01/message.hl7").toURI());
//        System.out.println(f.exists());
        
        String messageString = FileUtils.readFileToString(f);

        Report report = validator.check(messageString, "57a243d484ae5af0417e1faa");
    ...
    private static SyncHL7Validator createValidator()
        ...
        // The profile in XML
        InputStream profileXML =  TestPCD01.class.getResourceAsStream("/Global/Profile.xml");

        // The default conformance context file XML
        InputStream contextXML = TestPCD01.class.getResourceAsStream("/Global/Constraints.xml");

        // The value set library file XML
        InputStream vsLibXML = TestPCD01.class.getResourceAsStream("/Global/ValueSets.xml");
